...
loadStaticObjFiles("resources/obj/skybox/skybox.blend", objType["skybox"], "skybox", "skybox");
...
loadStaticObjFiles("resources/obj/landscape/landscape.obj", objType["landscape"], "landscape", "landscape");
