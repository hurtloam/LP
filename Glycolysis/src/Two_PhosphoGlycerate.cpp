...
Two_PhosphoGlycerate::Two_PhosphoGlycerate(int id, glm::vec3 scale, ObjectType objType, GLuint texture, glm::vec3 trans, LPWatch* watch, ResObj& resObj, const View& view, LPUniform lpUniform) : StaticObj(
...
Two_PhosphoGlycerate::~Two_PhosphoGlycerate() {
	// TODO Auto-generated destructor stub
}

void Two_PhosphoGlycerate::draw() {
	StaticObj::draw();
}

void Two_PhosphoGlycerate::move(bool flag) {
