...
WinningArea::WinningArea (int id,
                      ObjectType obj,
                      glm::vec3 shape,
...
//                   btVector3 (trans.x, trans.y, trans.z)));
  ...
  b_shape = new btBoxShape (btVector3 (8.0f, 2.0f, 4.0f));
...
void
WinningArea::setOpenDoor () {
//  std::cout << "ENTER MazeFloor::setOpenDoor" << std::endl;
//  openDoor = true;
}
void
WinningArea::move (std::vector<std::pair<int, int>> collisionDetected, glm::vec3 normal) {
