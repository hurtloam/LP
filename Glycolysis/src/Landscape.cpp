...
Landscape::Landscape(int id, glm::vec3 scale, ObjectType objType, GLuint texture, glm::vec3 trans, LPWatch* watch, ResObj& resObj, const View& view, 
...
void Landscape::move(bool flag) {

  static int timeDelay = 0;

//  if ((timeDelay % 10) == 0) {
//    setRotationMatrix_Y(0.008);
//    timeDelay = 1;
