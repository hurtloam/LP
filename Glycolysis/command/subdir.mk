...
$(SUB_DIR)/build/%.o: $(SUB_DIR)/src/%.cpp
	...
	g++ -D_LINUX -I"$(LP_ROOT)/BEvent" -I"$(LP_ROOT)/BEvent/inc" -I"$(LP_ROOT)/freetype-2.4.12/include" -I"$(LP_ROOT)/bullet3/src" -I"$(LP_ROOT)/assimp-5.3.1/include" -O0 -g3 -pedantic -Wall -Wextra -c -fmessage-length=0 -std=c++14 -fPIC -MMD -MP -MF"$(%.o)" -MT"$(%.o)" -o "$@" "$<"
#	g++ -D_LINUX -I"$(LP_ROOT)/BEvent" -I"$(LP_ROOT)/BEvent/inc" -I"$(LP_ROOT)/freetype-2.4.12/include" -I"$(LP_ROOT)/bullet3/src" -I"$(LP_ROOT)/assimp-5.3.1/include" -O0 -g3 -pedantic -Wall -Wextra -c -fmessage-length=0 -std=c++14 -fPIC -MMD -MP  -o "$@" "$<"
