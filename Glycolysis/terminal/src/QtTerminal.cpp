...
void QtTerminal::echoChanged(int index)
{
    ...
    case 0:
        ...
        std::cout << "setEchoMode - Normal" << std::endl;
        break;
    case 1:
        echoLineEdit->setEchoMode(QLineEdit::Password);
        std::cout << "setEchoMode - Password" << std::endl;
        break;
    case 2:
        echoLineEdit->setEchoMode(QLineEdit::PasswordEchoOnEdit);
        std::cout << "setEchoMode - PasswordEchoOnEdit" << std::endl;
        break;
    case 3:
        echoLineEdit->setEchoMode(QLineEdit::NoEcho);
        std::cout << "setEchoMode - NoEcho" << std::endl;
    }
}
...
//    QMainWindow *mainWindow = new QMainWindow();
    ...
    QObject::connect(echoComboBox, SIGNAL(activated(int)),
                this, SLOT(this->echoChanged(int)));

    QObject::connect(echoComboBox, SIGNAL(finish()),
                    this, SLOT(close()));
