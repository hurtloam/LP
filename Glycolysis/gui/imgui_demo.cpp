...
void ImGui::ShowActiveObjects(char info1[128], char info2[128], char info3[128],
                              char sdlInfo1[128], char sdlInfo2[128],
                              char sdlInfo3[128], char mInfo1[128],
                              char mInfo2[128], char mInfo3[128])
{
...
//  ImGui::Text(sdlInfo3);
  ...
  ImGui::Text("Camera position information should come here");
  ImGui::Text("Soon");
  ImGui::Text("");
...
bool ImGui::getStatusOfObjectWindow()
{
  return statusOfObjectWindow;
}


bool ImGui::getStatusOfStatusWindow()
{
  return statusOfStatusWindow;
}
...
static void ShowExampleMenuFile()
{
    ...
    if (ImGui::MenuItem("Quit", "Alt+F4")) {onGuiMainMenuFileQuit();}
}
