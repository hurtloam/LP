...
namespace ImGui
{
    ...
    IMGUI_API void          Render(ImGuiIO io);                                   // ends the ImGui frame, finalize rendering data, then call your io.RenderDrawListsFn() function if set.
    IMGUI_API void          Shutdown();

    // Demo/Debug/Info
//    IMGUI_API void          MainMenuBar();        // MainBar
    ...
    IMGUI_API void          ShowActiveObjects(char info1[128], char info2[128], char info3[128], char sdlInfo1[128], char sdlInfo2[128], char sdlInfo3[128],
                                              char mInfo1[128], char mInfo2[128], char mInfo3[128]);

    // My own (EPEBROR)
    IMGUI_API bool          getStatusOfObjectWindow();
    IMGUI_API bool          getStatusOfStatusWindow();
...
struct ImGuiIO
{
    ...
    void        (*RenderDrawListsFn)(ImDrawData* data, ImGuiIO& io);
